...
class GoslingAgent(BaseAgent):
    ...
    def initialize_agent(self):
        ...
        # Game time
        self.time = 0.0
        # Save last time the ready() function was run to decide whether to run again
    ...
    def get_ready(self, packet):
        ...
        self.last_ready_time = packet.game_info.seconds_elapsed
    ...
    def get_output(self, packet):
        ...
        if packet.game_info.seconds_elapsed - self.last_ready_time > 1:
